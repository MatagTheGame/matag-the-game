...
@Import(PutPlusOneCountersOnCreaturesTest.InitTestServiceForTest::class)
class PutPlusOneCountersOnCreaturesTest(var initService: InitTestService) : AbstractApplicationTest() {
