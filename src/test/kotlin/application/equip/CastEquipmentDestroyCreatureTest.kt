...
@Tag("RegressionTests")
@Import(CastEquipmentDestroyCreatureTest.InitTestServiceForTest::class)
class CastEquipmentDestroyCreatureTest(var initService: InitTestService) : AbstractApplicationTest() {
