...
@Import(CreatureEntersTheBattlefieldReturnTargetToHandTest.InitTestServiceForTest::class)
class CreatureEntersTheBattlefieldReturnTargetToHandTest(var initService: InitTestService) : AbstractApplicationTest() {
