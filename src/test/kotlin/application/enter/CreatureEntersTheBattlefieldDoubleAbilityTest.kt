...
@Tag("RegressionTests")
@Import(CreatureEntersTheBattlefieldDoubleAbilityTest.InitTestServiceForTest::class)
class CreatureEntersTheBattlefieldDoubleAbilityTest(var initService: InitTestService) : AbstractApplicationTest() {
