...
class EnterCardIntoBattlefieldServiceTest {
    ...
    fun enterTheBattlefield() {
        ...
        // Then
        Assertions.assertThat(card.modifiers.getPermanentId()).isGreaterThan(0)
        Assertions.assertThat<CardInstance?>(gameStatus.getPlayer1().battlefield.cards).contains(card)
    }
    ...
    fun enterTheBattlefieldOpponent() {
        ...
        // Then
        Assertions.assertThat(card.modifiers.getPermanentId()).isGreaterThan(0)
        Assertions.assertThat<CardInstance?>(gameStatus.getPlayer2().battlefield.cards).contains(card)
    }
    ...
    fun enterTheBattlefieldTrigger() {
        ...
        // Then
        Assertions.assertThat<CardInstance?>(gameStatus.stack.items).contains(card)
        Assertions.assertThat<Ability?>(card.triggeredAbilities).hasSize(1)
        Assertions.assertThat(card.triggeredAbilities.get(0).abilityTypeText).isEqualTo("That targets get +2/+2.")
    }
    ...
    fun enterTheBattlefieldAdamantTriggered() {
        ...
        gameStatus.turn.setLastManaPaid(
        ...
        // Then
        Assertions.assertThat(card.modifiers.counters.getPlus1Counters()).isEqualTo(1)
    }
    ...
    fun enterTheBattlefieldAdamantNotTriggered() {
        ...
        // Then
        Assertions.assertThat(card.modifiers.counters.getPlus1Counters()).isEqualTo(0)
    }
