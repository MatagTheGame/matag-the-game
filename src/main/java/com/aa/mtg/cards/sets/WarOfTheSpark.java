...
public class WarOfTheSpark implements MtgSet {
    ...
    public static Card RISING_POPULACE = new Card("Rising Populace", singleton(Color.WHITE), asList(Cost.WHITE, Cost.COLORLESS, Cost.COLORLESS), singletonList(CREATURE), singletonList(HUMAN), COMMON, "Whenever another creature or planeswalker you control dies, put a +1/+1 counter on Rising Populace.", 2, 2, singletonList(WHENEVER_ANOTHER_CREATURE_OR_PLANESWALKER_DIES_PUT_1_PLUS_1_COUNTER_ON_IT));
