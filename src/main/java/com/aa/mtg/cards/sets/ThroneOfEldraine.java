...
public class ThroneOfEldraine implements MtgSet {
    ...
    public static Card VENERABLE_KNIGHT = new Card("Venerable Knight", singleton(Color.WHITE), singletonList(Cost.WHITE), singletonList(CREATURE), asList(HUMAN, KNIGHT), UNCOMMON, "When Venerable Knight dies, put a +1/+1 counter on target Knight you control.", 2, 1, singletonList(WHEN_IT_DIES_PUT_A_PLUS_1_COUNTER_ON_TARGET_KNIGHT_YOU_CONTROL));
