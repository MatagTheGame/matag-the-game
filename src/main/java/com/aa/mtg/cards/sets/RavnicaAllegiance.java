...
public class RavnicaAllegiance implements MtgSet {
    ...
    public static Card BEDEVIL = new Card("Bedevil", asSet(Color.BLACK, Color.RED), asList(Cost.BLACK, Cost.BLACK, Cost.RED), singletonList(Type.INSTANT), emptyList(), "Destroy target artifact, creature, or planeswalker.", 0, 0, singletonList(DESTROY_TARGET_ARTIFACT_CREATURE_OR_PLANESWALKER));
