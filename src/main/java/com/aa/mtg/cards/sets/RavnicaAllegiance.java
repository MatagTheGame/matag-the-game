...
public class RavnicaAllegiance implements MtgSet {
    ...
    public static Card CONCORDIA_PEGASUS = new Card("Concordia Pegasus", singletonList(Color.WHITE), asList(Cost.WHITE, Cost.COLORLESS), singletonList(Type.CREATURE), singletonList("Pegasus"), "Flying", 1, 3, singletonList(FLYING));
