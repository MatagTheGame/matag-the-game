...
public class CoreSet2019 implements MtgSet {
    ...
    public static Card DAGGERBACK_BASILISK = new Card("Daggerback Basilisk", singletonList(Color.GREEN), asList(Cost.GREEN, Cost.COLORLESS, Cost.COLORLESS), singletonList(Type.CREATURE), singletonList("Basilisk"), "Deathtouch", 0, 0, singletonList(DEATHTOUCH));
